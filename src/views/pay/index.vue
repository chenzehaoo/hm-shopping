<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="addressSelect.address_id">
        <div class="info-content">
          <span class="name">{{ addressSelect.name }}</span>
          <span class="mobile">{{ addressSelect.phone }}</span>
        </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!addressSelect">请先选择配送地址</span>
...
export default {
  ...
  computed: {
    addressSelect () {
      // 这里收货地址不是主线业务，只需要取第一项出来
      return this.addressList[0] || {}
    },
    longAddress () {
      const region = this.addressSelect.region
      return region.city + region.province + region.region + this.addressSelect.detail
    },
    mode () {
